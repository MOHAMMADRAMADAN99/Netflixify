        ...
        <div class="movies owl-carousel owl-theme">
            ...
            @foreach ($latest_movies as $latest_movie)
                ...
                <div class="movie text-white d-flex justify-content-center align-items-center">
                    ...
                    <div class="movie__bg" style="background: center/cover no-repeat;">
                    <img src="{{ asset('images/'.$latest_movie->image) }}" alt="">
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mt-2 mx-auto col-md-4 col-lg-3  ml-md-auto mr-md-0">
                                <img src="{{ asset('images/'.$latest_movie->poster) }}" class="img-fluid" alt="">
                            </div>
                        </div><!-- end of row -->
            ...
            <div class="container">
                ...
                <div class="movies owl-carousel owl-theme">
                    ...
                    @foreach ($category->movies as $movie)
                        ...
                        <div class="movie p-0">
                            <img src="{{ asset('images/'.$movie->poster) }}" class="img-fluid" alt="">
