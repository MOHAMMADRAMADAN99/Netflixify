            ...
            <div class="tile shadow mb-4">
                ...
                >
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('images/'.$movie->poster) }}" style=" margin-top: 10px; width: 255px; height: 378px;" alt="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('images/'.$movie->image) }}" style=" margin-top: 10px; width: 300px; height: 300;" alt="">
                    </div>
